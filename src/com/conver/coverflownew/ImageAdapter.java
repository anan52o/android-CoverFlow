...
public class ImageAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		i.setLayoutParams(new CoverFlow.LayoutParams(320, 200));
	...
	public ImageView createReflectedImages(Context mContext, int imageId) {
		...
		Log.e("bitmapWithReflection宽度：", "" + bitmapWithReflection.getWidth());
		Log.e("bitmapWithReflection高度：", "" + bitmapWithReflection.getHeight());
		imageView.setImageBitmap(bitmapWithReflection);
		Log.e("imageView宽度：", "" + imageView.getWidth());
		Log.e("imageView高度：", "" + imageView.getHeight());
		return imageView;
	}
}
